...
const AboutUs = () => {
  ...
  const category =[

    {
      ...
      "title": "Рынки",
      "image": market,
      "description": "Рынки – это ваш надежный партнер в создании непревзойденных строительных проектов! Мы предоставляем широкий ассортимент высококачественных строительных материалов, чтобы удовлетворить потребности даже самых требовательных клиентов."
    },
    {
      "id": "2",
