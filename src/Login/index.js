    ...
    <div className=' w-full h-full flex justify-center items-center'>
      ...
      <Text
        ...
        <Text  className="text-base text-gray-600 tracking-[-0.15px] text-left w-auto mt-4 mb-1"
                          size="txtRobotoMedium12"> Электронная почта</Text>
        <input
                    name="email"
...
{errors.email && (
                ...
                {loading ? <ClipLoader color="#FFFFFF" size={30} /> : " Продолжать"}
                ...
                <div className=' w-full flex space-x-1 justify-center items-center'>
                  <Text className=' text-base text-yellow-800 mx-0' size="txtRobotoRomanSemiBold20">Попробуйте войти через?</Text>
                  <Text className=' text-base text-gray-900 cursor-pointer' size="txtRobotoBold18">Номер телефона</Text>
                </div>
